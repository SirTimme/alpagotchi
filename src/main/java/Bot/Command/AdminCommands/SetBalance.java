...
public class SetBalance implements ICommand {
   ...
   public void execute(CommandContext commandContext) {
      ...
      final int currentBalance = IDataBaseManager.INSTANCE.getInventory(mentionedUserID, "currency");
      int newBalance;
      ...
      IDataBaseManager.INSTANCE.setInventory(mentionedUserID, "currency", (newBalance - currentBalance));
